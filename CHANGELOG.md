...
- **Tokens**
  ...
  - [`erc1155`](https://github.com/pcaversaccio/snekmate/blob/v0.1.1/src/snekmate/tokens/erc1155.vy):
    ...
    - Use keyword arguments for event instantiation. ([#280](https://github.com/pcaversaccio/snekmate/pull/280))
- **Utility Functions**
  - [`base64`](https://github.com/pcaversaccio/snekmate/blob/v0.1.1/src/snekmate/utils/base64.vy): Use native hex `x"..."` string literals. ([#283](https://github.com/pcaversaccio/snekmate/pull/283))
