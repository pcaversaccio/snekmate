...
- **Extensions**
  - [`erc4626`](https://github.com/pcaversaccio/snekmate/blob/v0.1.2/src/snekmate/extensions/erc4626.vy): Use `_max_withdraw` amount of `owner` in `withdraw` function. ([#327](https://github.com/pcaversaccio/snekmate/pull/327))
