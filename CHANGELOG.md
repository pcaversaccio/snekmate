...
- **Authentication**
  - [`ownable`](https://github.com/pcaversaccio/snekmate/blob/v0.1.3/src/snekmate/auth/ownable.vy): Migrate `ownable` to custom `error`s.
  - [`ownable_2step`](https://github.com/pcaversaccio/snekmate/blob/v0.1.3/src/snekmate/auth/ownable_2step.vy): Migrate `ownable_2step` to custom `error`s.
- **Utility Functions**
