...
contract ERC4626VaultTest is ERC4626Test {
    ...
    function setUp() public override {
        ...
        ERC4626ExtendedDecimalsOffset0 = IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", argsDecimalsOffset0)
        );
        ...
        ERC4626ExtendedDecimalsOffset6 = IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", argsDecimalsOffset6)
        );
        ...
        ERC4626ExtendedDecimalsOffset12 = IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", argsDecimalsOffset12)
        );
        ...
        ERC4626ExtendedDecimalsOffset18 = IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", argsDecimalsOffset18)
        );
    ...
    function testInitialSetup() public {
        ...
        IERC4626Extended ERC4626ExtendedDecimalsOffsetEOA = IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", argsDecimalsOffsetEOA)
        );
        ...
        IERC4626Extended ERC4626ExtendedDecimalsOffsetNoDecimals = IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", argsDecimalsOffsetNoDecimals)
        );
        ...
        vm.expectRevert();
        IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", argsDecimalsOffsetOverflow)
        );
    }
...
contract ERC4626VaultInvariants is Test {
    ...
    function setUp() public {
        ...
        ERC4626Extended = IERC4626Extended(
            vyperDeployer.deployContract("src/snekmate/extensions/mocks/", "erc4626_mock", args)
        );
